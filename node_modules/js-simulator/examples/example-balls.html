<html>
    <head>
        <title>Discrete-Event Simulator: Balls</title>
        <script src="../src/jssim.js" type="text/javascript"></script>
    </head>
    <body>
        <h2>Discrete-Event Simulator: Balls <input type="text" id="simTime" value="" /></h2>
        
        <p>
            A demonstration of <a href="http://en.wikipedia.org/wiki/Hooke's_law">Hooke's Law</a>.  Balls of random location and mass are connected arbitrarily with rubber bands of random strength and minimum lax distance.  
        </p>
